...
aah introduced the Virtual FileSystem (VFS) feature in <span class="badge lb-sm">v0.11.0</span> [`aahframework.org/vfs.v0`](https://github.com/go-aah/vfs).
...
Configuration goes in `aah.project` (generated by the command, `aah new`).
