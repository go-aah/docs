...
Reference to [App Config](app-config.html), [Security Config](security-config.html), [Logging Config](logging-config.html).
  ...
  * [domains { ... }](#section-domains)
    - [domain { ... }](#section-unique-keyname-user-defined)
      ...
      * [static { ... }](#section-static)
          - [Sample config](#sample-config-for-static-section)
